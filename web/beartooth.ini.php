 ...
 * DO NOT edit this file, to override these settings use beartooth.local.ini.php instead.  Any
...
// tagged version
$SETTINGS[ 'general' ][ 'version' ] = '0.3.2';
...
$SETTINGS[ 'path' ][ 'BEARTOOTH' ] = '/usr/local/lib/beartooth';
...
$SETTINGS[ 'path' ][ 'LOG_FILE' ] = '/var/local/beartooth/log';

// the location of the compiled template cache
$SETTINGS[ 'path' ][ 'TEMPLATE_CACHE' ] =
  '/tmp/beartooth/'.substr( str_replace( '/', '_', dirname( __FILE__ ) ), 1 );
