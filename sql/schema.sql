...
CREATE TABLE IF NOT EXISTS `beartooth`.`qnaire` (
  ...
  INDEX `fk_qnaire_first_attempt_event_type_id` (`first_attempt_event_type_id` ASC),
  INDEX `fk_qnaire_reached_event_type_id` (`reached_event_type_id` ASC),
  INDEX `fk_qnaire_completed_event_type_id` (`completed_event_type_id` ASC),
...
-- -----------------------------------------------------
-- Table `beartooth`.`qnaire_has_quota`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `beartooth`.`qnaire_has_quota` ;

CREATE TABLE IF NOT EXISTS `beartooth`.`qnaire_has_quota` (
  `qnaire_id` INT UNSIGNED NOT NULL,
  `quota_id` INT UNSIGNED NOT NULL,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
...
-- -----------------------------------------------------
-- Table `beartooth`.`queue_state`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `beartooth`.`queue_state` ;

CREATE TABLE IF NOT EXISTS `beartooth`.`queue_state` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `queue_id` INT UNSIGNED NOT NULL,
