    ...
    SET @sql = CONCAT(
      ...
      "AND service.id NOT IN ( ",
        ...
        "WHERE subject IN( ",
          ...
          "'consent', 'consent_type', 'event', 'event_type', 'export', 'export_column', 'export_restriction', ",
          "'form', 'hin', 'interview', 'jurisdiction', 'language', 'onyx', 'phase', 'phone', 'qnaire', 'quota', ",
          "'region_site', 'recording', 'recording_list', 'report_schedule', 'script', 'source', 'state' ) ",
