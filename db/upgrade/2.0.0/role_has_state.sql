...
CREATE PROCEDURE patch_role_has_state()
  BEGIN
    ...
    SELECT "Adding new interviewer+ role to role_has_state" AS "";
    ...
    SET @sql = CONCAT(
      ...
      "JOIN ", @cenozo, ".role AS interviewer_role ON role_has_state.role_id = interviewer_role.id ",
      "WHERE role.name = 'interviewer+' ",
      "AND interviewer_role.name = 'interviewer'" );
