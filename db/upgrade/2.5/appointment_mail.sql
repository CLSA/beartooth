  ...
  BEGIN
    ...
    SET @sql = CONCAT(
      "CREATE TABLE IF NOT EXISTS appointment_mail ( ",
        ...
        "appointment_type_id INT UNSIGNED NULL DEFAULT NULL, ",
        ...
        "UNIQUE INDEX uq_site_id_qnaire_id_appointment_type_id_language_id_delay (site_id ASC, qnaire_id ASC, appointment_type_id ASC, language_id ASC, delay ASC), ",
        "CONSTRAINT fk_appointment_mail_site_id ",
          "FOREIGN KEY (site_id) ",
          "REFERENCES ", @cenozo, ".site (id) ",
          "ON DELETE CASCADE ",
          "ON UPDATE NO ACTION, ",
        "CONSTRAINT fk_appointment_mail_appointment_type_id ",
        ...
        "CONSTRAINT fk_appointment_mail_language_id ",
          ...
          "ON DELETE CASCADE ",
          "ON UPDATE NO ACTION, ",
        "CONSTRAINT fk_appointment_mail_qnaire_id ",
