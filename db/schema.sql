...
-- Schema beartooth
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `beartooth` DEFAULT CHARACTER SET utf8mb4 ;
-- -----------------------------------------------------
-- Schema cenozo
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `beartooth`.`appointment_type_reason`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `beartooth`.`appointment_type_reason` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
...
-- -----------------------------------------------------
-- Table `beartooth`.`custom_report`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `beartooth`.`custom_report` (
...
-- -----------------------------------------------------
-- Table `beartooth`.`interviewing_instance`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `beartooth`.`interviewing_instance` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
  `site_id` INT(10) UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `beartooth`.`jurisdiction`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `beartooth`.`jurisdiction` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
  `site_id` INT(10) UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `beartooth`.`qnaire_has_consent_type`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `beartooth`.`qnaire_has_consent_type` (
  `qnaire_id` INT(10) UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `beartooth`.`qnaire_has_event_type`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `beartooth`.`qnaire_has_event_type` (
  `qnaire_id` INT(10) UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `beartooth`.`qnaire_has_study`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `beartooth`.`qnaire_has_study` (
  `qnaire_id` INT(10) UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `beartooth`.`region_site`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `beartooth`.`region_site` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP(),
  `create_timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP(),
  `site_id` INT(10) UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `beartooth`.`role_has_custom_report`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `beartooth`.`role_has_custom_report` (
  `role_id` INT(10) UNSIGNED NOT NULL,
...
TRIGGER `beartooth`.`appointment_AFTER_INSERT`
...
USE `beartooth`$$
CREATE DEFINER = CURRENT_USER TRIGGER `beartooth`.`appointment_BEFORE_UPDATE` BEFORE UPDATE ON `appointment` FOR EACH ROW
BEGIN
...
CREATE
DEFINER=`patrick`@`localhost`
TRIGGER `beartooth`.`appointment_AFTER_UPDATE`
...
CREATE
DEFINER=`patrick`@`localhost`
TRIGGER `beartooth`.`appointment_AFTER_DELETE`
...
USE `beartooth`$$
CREATE DEFINER = CURRENT_USER TRIGGER `beartooth`.`appointment_BEFORE_INSERT` BEFORE INSERT ON `appointment` FOR EACH ROW
BEGIN
  IF (NEW.appointment_type_id IS NULL) THEN
    SET NEW.appointment_type_reason_id = NULL;
    SET NEW.reason_extra = NULL;
...
CREATE
DEFINER=`patrick`@`localhost`
TRIGGER `beartooth`.`assignment_AFTER_DELETE`
...
CREATE
DEFINER=`patrick`@`localhost`
TRIGGER `beartooth`.`assignment_AFTER_INSERT`
...
CREATE
DEFINER=`patrick`@`localhost`
TRIGGER `beartooth`.`assignment_AFTER_UPDATE`
...
CREATE
DEFINER=`patrick`@`localhost`
TRIGGER `beartooth`.`interview_AFTER_INSERT`
...
CREATE
DEFINER=`patrick`@`localhost`
TRIGGER `beartooth`.`interview_AFTER_UPDATE`
...
CREATE
DEFINER=`patrick`@`localhost`
TRIGGER `beartooth`.`interview_AFTER_DELETE`
...
CREATE
DEFINER=`patrick`@`localhost`
TRIGGER `beartooth`.`jurisdiction_AFTER_DELETE`
...
CREATE
DEFINER=`patrick`@`localhost`
TRIGGER `beartooth`.`jurisdiction_AFTER_INSERT`
...
CREATE
DEFINER=`patrick`@`localhost`
TRIGGER `beartooth`.`jurisdiction_AFTER_UPDATE`
...
CREATE
DEFINER=`patrick`@`localhost`
TRIGGER `beartooth`.`jurisdiction_BEFORE_DELETE`
...
CREATE
DEFINER=`patrick`@`localhost`
TRIGGER `beartooth`.`phone_call_AFTER_DELETE`
...
CREATE
DEFINER=`patrick`@`localhost`
TRIGGER `beartooth`.`phone_call_AFTER_INSERT`
...
CREATE
DEFINER=`patrick`@`localhost`
TRIGGER `beartooth`.`phone_call_AFTER_UPDATE`
...
CREATE
DEFINER=`patrick`@`localhost`
TRIGGER `beartooth`.`region_site_AFTER_DELETE`
...
CREATE
DEFINER=`patrick`@`localhost`
TRIGGER `beartooth`.`region_site_AFTER_INSERT`
...
CREATE
DEFINER=`patrick`@`localhost`
TRIGGER `beartooth`.`region_site_AFTER_UPDATE`
...
CREATE
DEFINER=`patrick`@`localhost`
TRIGGER `beartooth`.`region_site_BEFORE_DELETE`
