...
-- Wed 24 Feb 2016 04:37:38 PM EST
...
CREATE TABLE IF NOT EXISTS `beartooth`.`qnaire` (
  ...
  INDEX `fk_event_type_id` (`first_attempt_event_type_id` ASC),
  INDEX `fk_event_type_id` (`reached_event_type_id` ASC),
...
CREATE TABLE IF NOT EXISTS `beartooth`.`assignment` (
  ...
  INDEX `fk_assignment_id` (`queue_id` ASC),
