...
CREATE TABLE IF NOT EXISTS `beartooth`.`qnaire` (
  ...
  `prev_event_type_id` INT UNSIGNED NULL,
...
CREATE TABLE IF NOT EXISTS `beartooth`.`interview` (
  ...
  INDEX `dk_completed` (`start_datetime` ASC),
...
-- -----------------------------------------------------
-- Table `beartooth`.`appointment_type`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `beartooth`.`appointment_type` ;

CREATE TABLE IF NOT EXISTS `beartooth`.`appointment_type` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `name` VARCHAR(45) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `beartooth`.`appointment` (
  ...
  `outcome` ENUM('completed', 'cancelled') NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
-- -----------------------------------------------------
-- Table `beartooth`.`service`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `beartooth`.`service` ;

CREATE TABLE IF NOT EXISTS `beartooth`.`service` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
...
-- -----------------------------------------------------
-- Table `beartooth`.`role_has_service`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `beartooth`.`role_has_service` ;

CREATE TABLE IF NOT EXISTS `beartooth`.`role_has_service` (
  `role_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `beartooth`.`writelog`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `beartooth`.`writelog` ;

CREATE TABLE IF NOT EXISTS `beartooth`.`writelog` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `user_id` INT UNSIGNED NOT NULL,
  `site_id` INT UNSIGNED NOT NULL,
  `role_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `beartooth`.`participant_last_interview`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `beartooth`.`participant_last_interview` ;

CREATE TABLE IF NOT EXISTS `beartooth`.`participant_last_interview` (
  `participant_id` INT UNSIGNED NOT NULL,
  `interview_id` INT UNSIGNED NULL DEFAULT NULL,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
...
-- -----------------------------------------------------
-- Table `beartooth`.`interview_last_assignment`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `beartooth`.`interview_last_assignment` ;

CREATE TABLE IF NOT EXISTS `beartooth`.`interview_last_assignment` (
  `interview_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `beartooth`.`assignment_last_phone_call`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `beartooth`.`assignment_last_phone_call` ;

CREATE TABLE IF NOT EXISTS `beartooth`.`assignment_last_phone_call` (
  `assignment_id` INT UNSIGNED NOT NULL,
  `phone_call_id` INT UNSIGNED NULL DEFAULT NULL,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
...
CREATE TABLE IF NOT EXISTS `beartooth`.`setting` (
  ...
  `create_timestamp` TIMESTAMP NOT NULL,
  `site_id` INT UNSIGNED NOT NULL,
  `mail_name` VARCHAR(255) NULL,
  `mail_address` VARCHAR(127) NULL,
  ...
  `appointment_site_duration` INT NULL DEFAULT 120,
...
-- -----------------------------------------------------
-- Table `beartooth`.`access`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `beartooth`.`access` ;

CREATE TABLE IF NOT EXISTS `beartooth`.`access` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `user_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `beartooth`.`interview_last_appointment`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `beartooth`.`interview_last_appointment` ;

CREATE TABLE IF NOT EXISTS `beartooth`.`interview_last_appointment` (
  `interview_id` INT UNSIGNED NOT NULL,
  ...
  CONSTRAINT `fk_interview_last_appointment_interview_id1`
    FOREIGN KEY (`interview_id`)
    REFERENCES `beartooth`.`interview` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_interview_last_appointment_appointment_id1`
...
-- -----------------------------------------------------
-- Table `beartooth`.`qnaire_has_script`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `beartooth`.`qnaire_has_script` ;

CREATE TABLE IF NOT EXISTS `beartooth`.`qnaire_has_script` (
  `qnaire_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `beartooth`.`appointment_mail`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `beartooth`.`appointment_mail` ;

CREATE TABLE IF NOT EXISTS `beartooth`.`appointment_mail` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `site_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `beartooth`.`appointment_has_mail`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `beartooth`.`appointment_has_mail` ;

CREATE TABLE IF NOT EXISTS `beartooth`.`appointment_has_mail` (
...
-- -----------------------------------------------------
-- Table `beartooth`.`qnaire_has_collection`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `beartooth`.`qnaire_has_collection` ;

CREATE TABLE IF NOT EXISTS `beartooth`.`qnaire_has_collection` (
  `qnaire_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `beartooth`.`qnaire_has_hold_type`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `beartooth`.`qnaire_has_hold_type` ;

CREATE TABLE IF NOT EXISTS `beartooth`.`qnaire_has_hold_type` (
  `qnaire_id` INT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
-- Table `beartooth`.`qnaire_has_stratum`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `beartooth`.`qnaire_has_stratum` ;

CREATE TABLE IF NOT EXISTS `beartooth`.`qnaire_has_stratum` (
  `qnaire_id` INT UNSIGNED NOT NULL,
  ...
  INDEX `fk_qnaire_id` (`qnaire_id` ASC),
  CONSTRAINT `fk_qnaire_has_stratum_qnaire_id`
    FOREIGN KEY (`qnaire_id`)
    REFERENCES `beartooth`.`qnaire` (`id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_qnaire_has_stratum_stratum_id`
...
CREATE TABLE IF NOT EXISTS `cenozo`.`application` (
  ...
  `study_phase_id` INT UNSIGNED NULL,
...
USE `beartooth`;
DROP procedure IF EXISTS `beartooth`.`update_assignment_last_phone_call`;
...
USE `beartooth`;
DROP procedure IF EXISTS `beartooth`.`update_interview_last_assignment`;
...
USE `beartooth`;
DROP procedure IF EXISTS `beartooth`.`update_participant_last_interview`;
...
USE `beartooth`;
DROP procedure IF EXISTS `beartooth`.`update_interview_last_appointment`;
...
USE `beartooth`$$
DROP TRIGGER IF EXISTS `beartooth`.`interview_AFTER_INSERT` $$
USE `beartooth`$$
CREATE DEFINER = CURRENT_USER TRIGGER `beartooth`.`interview_AFTER_INSERT` AFTER INSERT ON `interview` FOR EACH ROW
BEGIN
...
USE `beartooth`$$
DROP TRIGGER IF EXISTS `beartooth`.`interview_AFTER_UPDATE` $$
USE `beartooth`$$
CREATE DEFINER = CURRENT_USER TRIGGER `beartooth`.`interview_AFTER_UPDATE` AFTER UPDATE ON `interview` FOR EACH ROW
BEGIN
  CALL update_participant_last_interview( NEW.participant_id );
  CALL update_interview_last_appointment( NEW.id );
  CALL update_interview_last_assignment( NEW.id );
...
USE `beartooth`$$
DROP TRIGGER IF EXISTS `beartooth`.`interview_AFTER_DELETE` $$
USE `beartooth`$$
CREATE DEFINER = CURRENT_USER TRIGGER `beartooth`.`interview_AFTER_DELETE` AFTER DELETE ON `interview` FOR EACH ROW
BEGIN
...
USE `beartooth`$$
DROP TRIGGER IF EXISTS `beartooth`.`assignment_AFTER_INSERT` $$
USE `beartooth`$$
CREATE DEFINER = CURRENT_USER TRIGGER `beartooth`.`assignment_AFTER_INSERT` AFTER INSERT ON `assignment` FOR EACH ROW
BEGIN
...
USE `beartooth`$$
DROP TRIGGER IF EXISTS `beartooth`.`assignment_AFTER_UPDATE` $$
USE `beartooth`$$
CREATE DEFINER = CURRENT_USER TRIGGER `beartooth`.`assignment_AFTER_UPDATE` AFTER UPDATE ON `assignment` FOR EACH ROW
BEGIN
  CALL update_interview_last_assignment( NEW.interview_id );
  CALL update_assignment_last_phone_call( NEW.id );
END;$$
...
USE `beartooth`$$
DROP TRIGGER IF EXISTS `beartooth`.`assignment_AFTER_DELETE` $$
USE `beartooth`$$
CREATE DEFINER = CURRENT_USER TRIGGER `beartooth`.`assignment_AFTER_DELETE` AFTER DELETE ON `assignment` FOR EACH ROW
BEGIN
...
USE `beartooth`$$
DROP TRIGGER IF EXISTS `beartooth`.`phone_call_AFTER_INSERT` $$
USE `beartooth`$$
CREATE DEFINER = CURRENT_USER TRIGGER `beartooth`.`phone_call_AFTER_INSERT` AFTER INSERT ON `phone_call` FOR EACH ROW
BEGIN
...
USE `beartooth`$$
DROP TRIGGER IF EXISTS `beartooth`.`phone_call_AFTER_UPDATE` $$
USE `beartooth`$$
CREATE DEFINER = CURRENT_USER TRIGGER `beartooth`.`phone_call_AFTER_UPDATE` AFTER UPDATE ON `phone_call` FOR EACH ROW
BEGIN
  CALL update_assignment_last_phone_call( NEW.assignment_id );
END;$$
...
USE `beartooth`$$
DROP TRIGGER IF EXISTS `beartooth`.`phone_call_AFTER_DELETE` $$
USE `beartooth`$$
CREATE DEFINER = CURRENT_USER TRIGGER `beartooth`.`phone_call_AFTER_DELETE` AFTER DELETE ON `phone_call` FOR EACH ROW
BEGIN
...
USE `beartooth`$$
DROP TRIGGER IF EXISTS `beartooth`.`appointment_AFTER_INSERT` $$
USE `beartooth`$$
CREATE DEFINER = CURRENT_USER TRIGGER `beartooth`.`appointment_AFTER_INSERT` AFTER INSERT ON `appointment` FOR EACH ROW
BEGIN
...
USE `beartooth`$$
DROP TRIGGER IF EXISTS `beartooth`.`appointment_AFTER_UPDATE` $$
USE `beartooth`$$
CREATE DEFINER = CURRENT_USER TRIGGER `beartooth`.`appointment_AFTER_UPDATE` AFTER UPDATE ON `appointment` FOR EACH ROW
BEGIN
  CALL update_interview_last_appointment( NEW.interview_id );
END;$$
...
USE `beartooth`$$
DROP TRIGGER IF EXISTS `beartooth`.`appointment_AFTER_DELETE` $$
USE `beartooth`$$
CREATE DEFINER = CURRENT_USER TRIGGER `beartooth`.`appointment_AFTER_DELETE` AFTER DELETE ON `appointment` FOR EACH ROW
BEGIN
...
USE `beartooth`$$
DROP TRIGGER IF EXISTS `beartooth`.`appointment_mail_BEFORE_INSERT` $$
USE `beartooth`$$
CREATE DEFINER = CURRENT_USER TRIGGER `beartooth`.`appointment_mail_BEFORE_INSERT` BEFORE INSERT ON `appointment_mail` FOR EACH ROW
BEGIN
  IF NEW.appointment_type_id IS NULL THEN
    SELECT COUNT(*) INTO @count
    FROM appointment_mail
    WHERE site_id = NEW.site_id
    AND qnaire_id = NEW.qnaire_id
    ...
    IF @count > 0 THEN
      ...
      SET @sql = CONCAT(
        "Duplicate entry '",
        NEW.site_id, "-", NEW.qnaire_id, "-NULL-", NEW.language_id, "-", delay,
        "' for key 'uq_site_id_qnaire_id_appointment_type_id_langauge_id_delay'"
      );
    END IF;
  END IF;
END$$
...
USE `beartooth`$$
DROP TRIGGER IF EXISTS `beartooth`.`appointment_mail_BEFORE_UPDATE` $$
USE `beartooth`$$
CREATE DEFINER = CURRENT_USER TRIGGER `beartooth`.`appointment_mail_BEFORE_UPDATE` BEFORE UPDATE ON `appointment_mail` FOR EACH ROW
BEGIN
  IF NEW.appointment_type_id IS NULL THEN
    SELECT COUNT(*) INTO @count
    FROM appointment_mail
