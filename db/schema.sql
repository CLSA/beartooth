...
-- Tue 04 Oct 2016 05:11:23 PM EDT
...
-- -----------------------------------------------------
-- Table `beartooth`.`recording`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `beartooth`.`recording` ;

CREATE TABLE IF NOT EXISTS `beartooth`.`recording` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `rank` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `beartooth`.`recording_file`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `beartooth`.`recording_file` ;

CREATE TABLE IF NOT EXISTS `beartooth`.`recording_file` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  ...
  CONSTRAINT `fk_recording_file_recording_id`
    ...
    REFERENCES `beartooth`.`recording` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
...
-- -----------------------------------------------------
-- Table `beartooth`.`qnaire_has_site`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `beartooth`.`qnaire_has_site` ;

CREATE TABLE IF NOT EXISTS `beartooth`.`qnaire_has_site` (
  `qnaire_id` INT UNSIGNED NOT NULL,
  `site_id` INT UNSIGNED NOT NULL,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
...
-- -----------------------------------------------------
-- Table `beartooth`.`export`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `beartooth`.`export` ;

CREATE TABLE IF NOT EXISTS `beartooth`.`export` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `title` VARCHAR(255) NOT NULL,
...
-- -----------------------------------------------------
-- Table `beartooth`.`export_column`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `beartooth`.`export_column` ;

CREATE TABLE IF NOT EXISTS `beartooth`.`export_column` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  ...
  CONSTRAINT `fk_export_column_export_id`
    ...
    REFERENCES `beartooth`.`export` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `beartooth`.`export_restriction`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `beartooth`.`export_restriction` ;

CREATE TABLE IF NOT EXISTS `beartooth`.`export_restriction` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `update_timestamp` TIMESTAMP NOT NULL,
  `create_timestamp` TIMESTAMP NOT NULL,
  `export_id` INT UNSIGNED NOT NULL,
  ...
  CONSTRAINT `fk_export_restriction_export_column_id`
    ...
    REFERENCES `beartooth`.`export_column` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
DELIMITER $$
USE `beartooth`$$
CREATE PROCEDURE `update_interview_last_appointment` ()
BEGIN
