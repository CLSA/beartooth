...
-- Tue 14 Jun 2016 10:30:49 AM EDT
...
CREATE TABLE IF NOT EXISTS `beartooth`.`queue_state` (
  ...
  INDEX `fk_qnaire_id` (`qnaire_id` ASC),
  INDEX `fk_site_id` (`site_id` ASC),
  CONSTRAINT `fk_queue_state_queue1`
    FOREIGN KEY (`queue_id`)
    REFERENCES `beartooth`.`queue` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_queue_state_site1`
    FOREIGN KEY (`site_id`)
    REFERENCES `cenozo`.`site` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_queue_state_qnaire1`
    FOREIGN KEY (`qnaire_id`)
    REFERENCES `beartooth`.`qnaire` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `beartooth`.`qnaire_has_event_type` ;
