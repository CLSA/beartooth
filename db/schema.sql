...
-- Fri 06 Mar 2015 12:17:34 PM EST
...
CREATE TABLE IF NOT EXISTS `beartooth`.`queue_state` (
  ...
  `qnaire_id` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_queue_state_queue1_idx` (`queue_id` ASC),
  INDEX `fk_queue_state_site1_idx` (`site_id` ASC),
  INDEX `fk_queue_state_qnaire1_idx` (`qnaire_id` ASC),
