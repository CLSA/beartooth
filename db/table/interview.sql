CREATE TABLE interview (
  ...
  interviewing_instance_id INT(10) UNSIGNED NULL DEFAULT NULL,
  ...
  INDEX fk_interviewing_instance_id (interviewing_instance_id ASC),
  ...
  CONSTRAINT fk_interview_site_id
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT fk_interview_interviewing_instance_id
    FOREIGN KEY (interviewing_instance_id)
    REFERENCES beartooth.interviewing_instance (id)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
