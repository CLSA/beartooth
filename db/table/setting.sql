CREATE TABLE setting (
  ...
  appointment_update_span int(10) unsigned NOT NULL DEFAULT 30,
  appointment_home_duration int(10) unsigned NOT NULL DEFAULT 120,
  appointment_site_duration int(10) unsigned NOT NULL DEFAULT 120,
