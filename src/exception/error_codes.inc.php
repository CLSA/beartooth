...
define( 'NOTICE__BEARTOOTH_DATABASE_CALLBACK__SAVE__ERRNO',
 ...
 * "runtime" error codes
 */
define( 'RUNTIME__BEARTOOTH_DATABASE_ASSIGNMENT__SAVE__ERRNO',
        RUNTIME_BEARTOOTH_BASE_ERRNO + 1 );
define( 'RUNTIME__BEARTOOTH_DATABASE_PHONE_CALL__SAVE__ERRNO',
