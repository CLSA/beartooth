...
define( 'RUNTIME__BEARTOOTH_SERVICE_PINE_POST__PROCESS_CONSENT__ERRNO',
        RUNTIME_BEARTOOTH_BASE_ERRNO + 8 );
define( 'RUNTIME__BEARTOOTH_SERVICE_PINE_POST__PROCESS_HIN__ERRNO',
        RUNTIME_BEARTOOTH_BASE_ERRNO + 9 );
define( 'RUNTIME__BEARTOOTH_SERVICE_PINE_POST__PROCESS_EXTENDED_HIN__ERRNO',
        RUNTIME_BEARTOOTH_BASE_ERRNO + 10 );
define( 'RUNTIME__BEARTOOTH_SERVICE_PINE_POST__PROCESS_PARTICIPANT__ERRNO',
